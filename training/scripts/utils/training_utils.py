...
def test_chat_template():
    ...
    conversation = {"quote" : "Tôi luôn cho rằng thay đổi chỉ trở nên căng thẳng và quá sức chịu đựng khi bạn đánh mất cảm giác về sự kiên định trong cuộc sống của mình. Bạn cần một nền đất vững chắc để đứng lên. Từ đó, bạn có thể đối phó với sự thay đổi đó.", "topic" : "Life and Insprirational"}
